# my favorite game I have made so far!!
...
# Game Loop so the game always run
running = True
while running:
    ...
    for event in pygame.event.get():
        ...
        # if keystroke is pressed check to see if its right or left
    ...
    # 5 = 5 + -0.3 -> 5 = 5 - 0.3 - what happens in the if statement
